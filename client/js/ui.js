...
function editItem(key) {
	...
	if (key in PlayerWho && !(key in DBInventory) && ((item?.desc === false) || (item.type === "gadget" || item.type === "text" || item.type === "image" || item.type === "map_tile" || item.type === "tileset" || item.type === "landmark"))) {
